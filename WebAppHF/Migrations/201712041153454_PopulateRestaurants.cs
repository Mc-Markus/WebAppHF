namespace WebAppHF.Migrations
{
    ...
    public partial class PopulateRestaurants : DbMigration
    {
        ...
        {
            Sql("INSERT INTO Restaurants (NAME, ADDRESS, STARS, PRICE, REDUCEDPRICE, FOODTYPES, FOODIMGSTRING, RESTAURANTIMGSTRING) VALUES ('RestaurantModel Mr. & Mrs.', 'Lange Veerstraat 4, 2011 DB Haarlem, Nederland', 4, 4500, 2250, 'Dutch, fish and seafood, European', '/IMG/food1.jpg', '/IMG/restaurant1.jpg')");
            ...
            Sql("INSERT INTO Restaurants (NAME, ADDRESS, STARS, PRICE, REDUCEDPRICE, FOODTYPES, FOODIMGSTRING, RESTAURANTIMGSTRING) VALUES ('RestaurantModel ML', 'Kleine Houtstraat 70, 2011 DR Haarlem, Nederland', 4, 4500, 2250, 'Dutch, fish and seafood, European', '/IMG/food3.jpg', '/IMG/restaurant3.jpg')");
            Sql("INSERT INTO Restaurants (NAME, ADDRESS, STARS, PRICE, REDUCEDPRICE, FOODTYPES, FOODIMGSTRING, RESTAURANTIMGSTRING) VALUES ('RestaurantModel Fris', 'Twijnderslaan 7, 2012 BG Haarlem, Nederland', 4, 4500, 2250, 'Dutch, French, European', '/IMG/food4.jpg', '/IMG/restaurant4.jpg')");
